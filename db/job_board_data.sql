...
INSERT into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (1, 'Jakob', 'Moore', '1978-1-6', 'jmoore0@netscape.com',
        '$2a$04$oP1GenruvjoiwPNmyTTiHu5aEDM2Rjdfbb1RABJP04IAG87TXQjJ2', '602-285-2672', '802 Blackbird Circle',
        'Phoenix', 'Arizona', '85077');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (2, 'Lynnett', 'Sloss', '2007-11-23', 'lsloss1@wikimedia.org',
        '$2a$04$pXKFwGQze31UisEbwqI9BO4gQakxj3yqoJQUy5NVlV94rn29R0Ijy', '515-750-1658', '19023 Knutson Park',
        'Des Moines', 'Iowa', '50393');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (3, 'Vinni', 'Kaye', '1960-7-10', 'vkaye2@hatena.ne.jp',
        '$2a$04$YfGKvQGoe/7rTROUwqwPquFcIa4HcFxtQ1FM0eanhtEFj6PjImd4u', '415-123-5783', '326 Fairfield Plaza',
        'San Francisco', 'California', '94164');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (4, 'Arri', 'Vanns', '1966-11-25', 'avanns3@imageshack.us',
        '$2a$04$DLOzXiRiOoN25B50.jU09uSU/7xtG6o.GYEbfKdxDe.iGqOpxfcZu', '812-203-4104', '131 Columbus Plaza',
        'Evansville', 'Indiana', '47737');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (5, 'Yard', 'Verchambre', '1966-10-6', 'yverchambre4@bing.com',
        '$2a$04$TWlJIx9BGpNs569IQdcHfeldJGouaYlPuj8fkODUFoSzoarkX5uii', '414-559-6678', '5 Lindbergh Hill', 'Milwaukee',
        'Wisconsin', '53215');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (6, 'Guenevere', 'Traut', '1988-12-5', 'gtraut5@i2i.jp',
        '$2a$04$tFUSVuxwOYirP8z1oVmLVuv0v0CQzV557YW/OiAx21OWyHrbVtGG2', '203-583-0171', '6 Drewry Crossing',
        'Waterbury', 'Connecticut', '06705');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (7, 'Julita', 'Feeham', '2004-5-24', 'jfeeham6@paginegialle.it',
        '$2a$04$t3/olklrgRgvl60im4nzbuUUW3D3QMNo1PbAvllyG41m3isu8OYre', '614-379-7235', '4880 Sugar Hill', 'Columbus',
        'Ohio', '43240');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (8, 'Jessey', 'Smither', '1994-11-12', 'jsmither7@sun.com',
        '$2a$04$DgMR4IKFPTHtMIibYGm54.p5Wro.EjX1OuwSM8NN3LmHydIO4/qkm', '402-411-7733', '00 Service Circle', 'Omaha',
        'Nebraska', '68179');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (9, 'Lilias', 'Smallsman', '1998-1-19', 'lsmallsman8@si.edu',
        '$2a$04$o87dX8uy3nJKT.5s.ZohpOYZvxP3E2bXyh.flLOU2AmjeUmmVNjZy', '314-121-7981', '326 Thierer Plaza',
        'Saint Louis', 'Missouri', '63126');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (10, 'Nonna', 'Roakes', '1986-7-25', 'nroakes9@github.io',
        '$2a$04$rKUJBLo2icA/KUafX6XCO.7pobARxNm3FFlBV3EvYvFEGTN5wvcPS', '917-242-7118', '570 Florence Terrace',
        'Jamaica', 'New York', '11436');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (11, 'Winne', 'Kuhnke', '1977-8-5', 'wkuhnkea@cyberchimps.com',
        '$2a$04$3/Xd.EtRPm2nIorONbdwwuwHoRAB5JSwQnKvPmtpY1wCmuFI.k6V6', '718-886-6515', '90971 Redwing Trail', 'Bronx',
        'New York', '10474');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (12, 'Robinett', 'Schoenrock', '1959-6-28', 'rschoenrockb@nature.com',
        '$2a$04$8KU2g3WZMeNYZY/fApo0TeC94U1KOsfAy6z026s92TZ3XT8fhykQq', '504-176-1549', '84 Northport Parkway',
        'New Orleans', 'Louisiana', '70179');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (13, 'Lou', 'Seth', '2001-6-1', 'lsethc@behance.net',
        '$2a$04$pLbMFixadf8EgSuxBZRUh.MbFJNZu2LWhk5cp97p3vxXkKoa0M5QS', '410-752-9203', '2 Jenifer Crossing', 'Ridgely',
        'Maryland', '21684');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (14, 'Modesty', 'Shall', '1973-7-1', 'mshalld@smh.com.au',
        '$2a$04$vGz23UptNqNXirvovYwqJeSgCgDiQGwTIm3EBS44a2Y0wb.c8um9G', '808-923-9099', '1133 Muir Road', 'Honolulu',
        'Hawaii', '96840');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (15, 'Kalie', 'Ditter', '1983-7-9', 'kdittere@youtu.be',
        '$2a$04$o2Z4KTDdbXpW0pJhgQxUZ.QxnOh/ZJGGnzEVIIHvBq/6vXW0TD2Iy', '414-943-9022', '27 Eagle Crest Street',
        'Milwaukee', 'Wisconsin', '53220');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (16, 'Bealle', 'Lemerle', '1989-8-23', 'blemerlef@friendfeed.com',
        '$2a$04$ZPpB0Y84EbmkjoGWkUeKGezMaavO2LlyduYOGHq1zmb5LbY3iS2XG', '214-406-8346', '11262 Derek Parkway', 'Dallas',
        'Texas', '75397');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (17, 'Conny', 'Kilfoyle', '1970-4-24', 'ckilfoyleg@mail.ru',
        '$2a$04$TLEEIzIsf95OhAM3T.Tm0O/JZDH2qZ30H/uY0zNLMR6Nn5CUTlez.', '727-465-6935', '6 Oak Valley Court',
        'Saint Petersburg', 'Florida', '33737');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (18, 'Alix', 'Aneley', '1991-2-26', 'aaneleyh@feedburner.com',
        '$2a$04$JFO3kHnefEHOKdj7/8N0W.kGzo9cBVeCzMcWXg6U/kZiGuQabfMMa', '912-637-0147', '8 Di Loreto Center',
        'Savannah', 'Georgia', '31422');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (19, 'Blayne', 'Hembrow', '1977-6-7', 'bhembrowi@hubpages.com',
        '$2a$04$QS8NXe0.DDzxEexn7WDo5OH.1Csj2HmcDsT.c2HZLEn5vX16A96uO', '602-371-9701', '8 Saint Paul Plaza', 'Phoenix',
        'Arizona', '85020');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (20, 'Bride', 'Soot', '1973-1-22', 'bsootj@blog.com',
        '$2a$04$dWI4bGwXlgMPs5bYIRjUP.eRAPhlL6TGRrjP3o4J3L3NXpv5cAI2i', '509-837-5792', '77 Oak Drive', 'Spokane',
        'Washington', '99210');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (21, 'Therine', 'Pablos', '1994-5-27', 'tpablosk@histats.com',
        '$2a$04$e./k.TcdSruC5Frlv7iRmeHaje7Yj0S8wlLNtdYtaOEtAXPzZAS9u', '325-243-7935', '741 Donald Alley', 'Abilene',
        'Texas', '79699');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (22, 'Beilul', 'Starrs', '1994-4-9', 'bstarrsl@naver.com',
        '$2a$04$OuDPXAArf/lmEFWi84W3I.vS/Cp3nhRWVtXx1.t2PHAKYFo.Aw2im', '305-670-9632', '07 Redwing Court', 'Miami',
        'Florida', '33142');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (23, 'Ermengarde', 'Sidey', '1969-3-4', 'esideym@delicious.com',
        '$2a$04$jJUZzoJrf24OxLHKrqgcxe.YSI3MFU7sZ7HzCTQrxkzSXXI/P187a', '720-699-6490', '5 Cambridge Avenue', 'Denver',
        'Colorado', '80255');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (24, 'Katharyn', 'Lattos', '1964-3-31', 'klattosn@amazon.de',
        '$2a$04$ZCqga3KqW3DfEgzEY9opTe4gs/s3K/FGSoMKtu0Y7tFO8307h/XXG', '310-188-2376', '41 Straubel Lane',
        'San Francisco', 'California', '94105');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (25, 'Emlynn', 'Gartsyde', '1995-4-18', 'egartsydeo@sina.com.cn',
        '$2a$04$7ZuKMMx44vd5EWfuFqVcKeYPYGoVPWh/EsTi04Nk21js49ucSW05y', '334-742-1754', '992 Little Fleur Trail',
        'Montgomery', 'Alabama', '36195');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (26, 'Abrahan', 'Jakubovicz', '1993-11-8', 'ajakuboviczp@google.com.au',
        '$2a$04$K5VG6MvSUMvVAEcahWq0HOpZ3nmAe/ioZEi/uN.oUn8R2h3SvWMHS', '808-886-2271', '080 Manitowish Alley',
        'Honolulu', 'Hawaii', '96840');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (27, 'Donn', 'Bolt', '1992-12-9', 'dboltq@bluehost.com',
        '$2a$04$HrVvkLJ3SPi3.3qpNZycGuo3YOdQ1DQADEFd5VUq5UkOq86l4AfEi', '571-908-4256', '6 Bellgrove Place',
        'Merrifield', 'Virginia', '22119');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (28, 'Adiana', 'Hassin', '2002-7-20', 'ahassinr@clickbank.net',
        '$2a$04$EFrEGMuTyFnQCSomilprdOJBy58yLsZFTeH7HSz8oIoJ5arTSqEYW', '562-403-3332', '8274 Del Sol Crossing',
        'Los Angeles', 'California', '90015');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (29, 'Giffy', 'Jagels', '1967-2-1', 'gjagelss@simplemachines.org',
        '$2a$04$aBmMPz7ACHdGhOnrSkDFn.kDHzGcVj92MUvJVfAFyyppF5byDP246', '917-925-2348', '25693 Buell Way', 'Jamaica',
        'New York', '11436');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (30, 'Mallory', 'Allibon', '1985-9-10', 'mallibont@usgs.gov',
        '$2a$04$x.YcVfcBbI7Xoj8VKNqbGeO2s7yoOfSv34gdEHhBcZl9SbOIGy3ri', '314-165-0048', '487 Fremont Junction',
        'Saint Louis', 'Missouri', '63196');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (31, 'Eloisa', 'Plessing', '1988-3-16', 'eplessingu@uol.com.br',
        '$2a$04$GdXpY2Y.5CVQdCSNTQ5QUu7qV6g29Nlwmlzv3J4gWc2.TUgxXJH1y', '727-463-4875', '4 Everett Way', 'Clearwater',
        'Florida', '34620');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (32, 'Carlota', 'Pinchen', '2005-9-22', 'cpinchenv@so-net.ne.jp',
        '$2a$04$zzSXQh189IiuqpQP85dpzeEKlWsiNyHp58H.L1yxJHSqzLlWn93By', '936-551-2980', '5 Cascade Center', 'Beaumont',
        'Texas', '77713');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (33, 'Gratia', 'Nisius', '1969-6-9', 'gnisiusw@storify.com',
        '$2a$04$bJcUqWoPRwTqlib950RayeIrpeEMvyFscmcDGZ0l4e.po3Sxd.W6a', '339-346-3909', '23826 Carpenter Lane', 'Lynn',
        'Massachusetts', '01905');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (34, 'Moe', 'Czapla', '1958-7-15', 'mczaplax@miitbeian.gov.cn',
        '$2a$04$G1edeZZFleR/3pyxKzZgb.F/ATIqVmT.A6kVgBD.a98SHHNKozUY2', '804-153-7102', '844 Lerdahl Alley', 'Richmond',
        'Virginia', '23208');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (35, 'Abramo', 'Flucks', '1965-10-19', 'aflucksy@bloglines.com',
        '$2a$04$rvdeAXOFgMMva.WRZKCGhuxKvrH7waZ9v4zL2xLEtG0Jd6Xl6hMCu', '612-823-3750', '45 Fisk Drive', 'Saint Paul',
        'Minnesota', '55123');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (36, 'Mei', 'Goldby', '1971-7-24', 'mgoldbyz@cnet.com',
        '$2a$04$ENQnS8dBZkzDVpsMbcnU6ePmrKtPJG84xILpZVe3YflvaybThjts2', '610-272-8733', '792 Corscot Drive',
        'Allentown', 'Pennsylvania', '18105');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (37, 'Lilli', 'Egar', '2005-2-5', 'legar10@liveinternet.ru',
        '$2a$04$4DSOT0XobSxOyXcTtEg0DuuR0YaTBA43kfyX8o5XmqFmct5zTCgAa', '919-141-5191', '70 Randy Crossing', 'Raleigh',
        'North Carolina', '27610');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (38, 'Carlyle', 'Ropkins', '2002-1-3', 'cropkins11@seattletimes.com',
        '$2a$04$XjE3IjYsy56NICNsHDX7Yu3eih.hOxpxSecosYuy23e2WnKAlKI4.', '817-769-9683', '3 Clarendon Crossing',
        'Fort Worth', 'Texas', '76129');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (39, 'York', 'Thurstan', '1998-1-3', 'ythurstan12@webnode.com',
        '$2a$04$tx7v6oYxiaVLi4UfqWjRe.QooH1oId2.14CreyP74xgsSEKXOYJre', '812-742-6915', '264 Mockingbird Lane',
        'Evansville', 'Indiana', '47747');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (40, 'Shirlene', 'Yoxall', '1966-1-3', 'syoxall13@unesco.org',
        '$2a$04$X7bAl8PbA/DfR75b4GuOAOQT4eOXq4Hu3J8sax3jsSue3utJ4FsVi', '312-339-2759', '93675 Caliangt Trail',
        'Chicago', 'Illinois', '60609');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (41, 'Kassia', 'Wenn', '1986-10-18', 'kwenn14@ibm.com',
        '$2a$04$fLLGu6aG2OkUAr5Vve9Lne5W62KUyZHsryy51QOnTjGU4xF5Yu/Km', '360-208-9942', '4 Acker Junction', 'Seattle',
        'Washington', '98158');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (42, 'Martin', 'Paulmann', '1994-8-27', 'mpaulmann15@cloudflare.com',
        '$2a$04$RQFSsJVF8abyzRG7o2fetOcx3IgqnHDroxRD.eyZ2ScsOD6v.kbc2', '808-113-5534', '64 Nevada Place', 'Honolulu',
        'Hawaii', '96845');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (43, 'Ursuline', 'Tuminini', '1972-11-22', 'utuminini16@fema.gov',
        '$2a$04$0p85VKH/NjQBW223jBCAdOjsGKOOAaUDDblh1gOW57LiCwAOpUCjS', '513-395-1531', '676 Prairie Rose Circle',
        'Cincinnati', 'Ohio', '45271');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (44, 'Melamie', 'Moland', '1980-5-7', 'mmoland17@hibu.com',
        '$2a$04$MDum68MpAZmwULIwFNWkAe0BnhaefCK0xa3u3N292KBz6SBssloKm', '916-249-0536', '6998 Monument Lane',
        'Sacramento', 'California', '94263');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (45, 'Shelley', 'Sudran', '2002-3-2', 'ssudran18@omniture.com',
        '$2a$04$vqDNyROly9mdqLRiZVtOJ.lMUWGpCHoec4et4uKLvOiCGGJ6miWYO', '509-362-5595', '7445 Hintze Point', 'Spokane',
        'Washington', '99210');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (46, 'Bryana', 'Bolles', '2004-6-5', 'bbolles19@woothemes.com',
        '$2a$04$2J7ZMjd15Y4JeNm7i8DnG.zJ8MWdGibD0xtmhUqLn7fElDhf2RsG2', '225-710-0795', '99023 Burning Wood Place',
        'Baton Rouge', 'Louisiana', '70894');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (47, 'Enrika', 'Saunderson', '1964-12-12', 'esaunderson1a@csmonitor.com',
        '$2a$04$ksj1GcIIzA0cKRmh0iAM9eY/HBbaQtEUqHkfDLBLzsWrOI3ev7Qx6', '520-603-8243', '4 Burrows Terrace', 'Tucson',
        'Arizona', '85743');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (48, 'Davin', 'Leedal', '1999-1-16', 'dleedal1b@ovh.net',
        '$2a$04$G8S3rQzh6TuqZBJR4OZH6OnXcg88nTSJCrC0gtU2sjceziu4CyAFO', '720-843-6616', '4284 Pine View Plaza',
        'Arvada', 'Colorado', '80005');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (49, 'Marnie', 'De Roeck', '1985-7-17', 'mderoeck1c@naver.com',
        '$2a$04$SdB9ZOJg6GUzudg6RRs1geZaSH0b.fsRJTSdu4vDOEL1j2h0G7Dym', '713-767-9035', '78356 Maple Hill', 'Houston',
        'Texas', '77260');
insert into applicant (ID, FirstName, LastName, DOB, Email, PasswordHASH, Phone, StreetAddress, City, State, Zip)
values (50, 'Binky', 'Scarfe', '1966-10-20', 'bscarfe1d@rakuten.co.jp',
        '$2a$04$xekifd29obqEvt7IIkBJY.P1OOO2sNDnyIXqVKtM6xg.j/iVrsxbW', '952-887-3811', '5758 Autumn Leaf Plaza',
        'Young America', 'Minnesota', '55551');

-- wants


insert into wants (WantID, ApplicantID, WantDescription)
values (1, '27', 'nam congue risus semper porta volutpat quam');
insert into wants (WantID, ApplicantID, WantDescription)
values (2, '4', 'eu pede');
insert into wants (WantID, ApplicantID, WantDescription)
values (3, '32', 'lacinia');
insert into wants (WantID, ApplicantID, WantDescription)
values (4, '15', 'nulla tellus in sagittis dui vel nisl');
insert into wants (WantID, ApplicantID, WantDescription)
values (5, '9', 'in libero ut massa volutpat convallis morbi');
insert into wants (WantID, ApplicantID, WantDescription)
values (6, '36', 'orci mauris lacinia sapien');
insert into wants (WantID, ApplicantID, WantDescription)
values (7, '11', 'justo maecenas rhoncus aliquam lacus morbi quis tortor');
insert into wants (WantID, ApplicantID, WantDescription)
values (8, '35', 'feugiat non pretium quis lectus suspendisse');
insert into wants (WantID, ApplicantID, WantDescription)
values (9, '39', 'justo nec condimentum neque sapien');
insert into wants (WantID, ApplicantID, WantDescription)
values (10, '43', 'pede morbi porttitor lorem id ligula');
insert into wants (WantID, ApplicantID, WantDescription)
values (11, '37', 'et magnis dis parturient');
insert into wants (WantID, ApplicantID, WantDescription)
values (12, '40', 'augue aliquam erat volutpat in congue etiam justo');
insert into wants (WantID, ApplicantID, WantDescription)
values (13, '18', 'eleifend quam a odio in hac');
insert into wants (WantID, ApplicantID, WantDescription)
values (14, '30', 'nunc purus phasellus in felis donec semper');
insert into wants (WantID, ApplicantID, WantDescription)
values (15, '3', 'mi nulla');
insert into wants (WantID, ApplicantID, WantDescription)
values (16, '23', 'orci luctus et ultrices posuere cubilia curae donec');
insert into wants (WantID, ApplicantID, WantDescription)
values (17, '34', 'aliquet massa id lobortis convallis tortor risus dapibus');
insert into wants (WantID, ApplicantID, WantDescription)
values (18, '10', 'nibh in lectus pellentesque at nulla suspendisse potenti');
insert into wants (WantID, ApplicantID, WantDescription)
values (19, '22', 'a odio');
insert into wants (WantID, ApplicantID, WantDescription)
values (20, '46', 'cursus urna ut tellus nulla ut erat');
insert into wants (WantID, ApplicantID, WantDescription)
values (21, '38', 'lorem ipsum dolor sit');
insert into wants (WantID, ApplicantID, WantDescription)
values (22, '31', 'porttitor lorem id ligula suspendisse');
insert into wants (WantID, ApplicantID, WantDescription)
values (23, '8', 'tempor turpis nec euismod scelerisque quam');
insert into wants (WantID, ApplicantID, WantDescription)
values (24, '26', 'faucibus accumsan odio curabitur convallis');
insert into wants (WantID, ApplicantID, WantDescription)
values (25, '33', 'nec sem duis aliquam');
insert into wants (WantID, ApplicantID, WantDescription)
values (26, '25', 'dolor vel est donec odio justo');
insert into wants (WantID, ApplicantID, WantDescription)
values (27, '48', 'amet cursus id turpis integer');
insert into wants (WantID, ApplicantID, WantDescription)
values (28, '28', 'nec molestie sed justo pellentesque viverra pede ac');
insert into wants (WantID, ApplicantID, WantDescription)
values (29, '41', 'rutrum ac lobortis');
insert into wants (WantID, ApplicantID, WantDescription)
values (30, '45', 'donec');
insert into wants (WantID, ApplicantID, WantDescription)
values (31, '24', 'at nunc commodo placerat praesent');
insert into wants (WantID, ApplicantID, WantDescription)
values (32, '42', 'fringilla rhoncus mauris enim');
insert into wants (WantID, ApplicantID, WantDescription)
values (33, '50', 'vel dapibus at diam nam tristique tortor eu');
insert into wants (WantID, ApplicantID, WantDescription)
values (34, '1', 'velit id pretium');
insert into wants (WantID, ApplicantID, WantDescription)
values (35, '2', 'nunc donec quis');
insert into wants (WantID, ApplicantID, WantDescription)
values (36, '12', 'vestibulum sagittis sapien cum sociis natoque');
insert into wants (WantID, ApplicantID, WantDescription)
values (37, '13', 'at lorem integer tincidunt');
insert into wants (WantID, ApplicantID, WantDescription)
values (38, '29', 'neque aenean auctor gravida sem praesent id');
insert into wants (WantID, ApplicantID, WantDescription)
values (39, '21', 'elit sodales scelerisque mauris sit amet');
insert into wants (WantID, ApplicantID, WantDescription)
values (40, '6', 'id pretium iaculis diam erat fermentum justo');
insert into wants (WantID, ApplicantID, WantDescription)
values (41, '5', 'tempus vivamus in felis eu sapien');
insert into wants (WantID, ApplicantID, WantDescription)
values (42, '16', 'vel augue');
insert into wants (WantID, ApplicantID, WantDescription)
values (43, '19', 'interdum mauris ullamcorper purus');
insert into wants (WantID, ApplicantID, WantDescription)
values (44, '17', 'leo pellentesque ultrices mattis odio donec vitae nisi');
insert into wants (WantID, ApplicantID, WantDescription)
values (45, '47', 'vestibulum sit amet cursus id');
insert into wants (WantID, ApplicantID, WantDescription)
values (46, '44', 'sodales sed tincidunt eu felis');
insert into wants (WantID, ApplicantID, WantDescription)
values (47, '49', 'aliquet massa');
insert into wants (WantID, ApplicantID, WantDescription)
values (48, '14', 'cras in purus eu');
insert into wants (WantID, ApplicantID, WantDescription)
values (49, '7', 'turpis integer aliquet massa id');
insert into wants (WantID, ApplicantID, WantDescription)
values (50, '20', 'lectus in est risus auctor sed');

-- pdf resume


insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (1, '21', 'amet.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (2, '2', 'proin.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (3, '19', 'maecenas.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (4, '30', 'sagittis.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (5, '28', 'volutpat.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (6, '35', 'in.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (7, '11', 'vehicula.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (8, '36', 'nisi.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (9, '40', 'in.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (10, '45', 'penatibus.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (11, '46', 'mauris.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (12, '17', 'morbi.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (13, '50', 'rutrum.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (14, '16', 'a.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (15, '27', 'odio.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (16, '5', 'nunc.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (17, '39', 'in.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (18, '8', 'nibh.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (19, '18', 'integer.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (20, '41', 'felis.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (21, '32', 'pede.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (22, '10', 'pharetra.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (23, '1', 'aliquet.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (24, '12', 'posuere.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (25, '33', 'dictumst.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (26, '38', 'sapien.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (27, '14', 'posuere.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (28, '47', 'ipsum.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (29, '25', 'lobortis.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (30, '43', 'lacinia.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (31, '22', 'consectetuer.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (32, '13', 'pellentesque.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (33, '29', 'eleifend.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (34, '44', 'nunc.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (35, '4', 'nibh.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (36, '7', 'in.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (37, '49', 'vitae.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (38, '6', 'vestibulum.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (39, '48', 'aliquam.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (40, '9', 'arcu.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (41, '24', 'vel.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (42, '3', 'aliquam.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (43, '42', 'augue.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (44, '26', 'odio.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (45, '20', 'eu.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (46, '15', 'nisl.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (47, '23', 'eu.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (48, '31', 'semper.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (49, '37', 'pede.pdf');
insert into pdf_resume (pdfID, ApplicantID, PdfFilename)
values (50, '34', 'nisl.pdf');


-- company


insert into company (CompanyID, Name, about)
values (1, 'Divanoodle',
...
insert into company (CompanyID, Name, about)
values (3, 'Mynte', 'Etiam vel augue. Vestibulum rutrum rutrum neque.');
insert into company (CompanyID, Name, about)
values (4, 'Feedbug',
        'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.');
insert into company (CompanyID, Name, about)
values (5, 'Browsedrive',
...
insert into company (CompanyID, Name, about)
values (7, 'Twitternation', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.');
insert into company (CompanyID, Name, about)
values (8, 'Pixope',
...
insert into company (CompanyID, Name, about)
values (15, 'Dazzlesphere',
        'In est risus, auctor sed, tristique in, tempus sit amet, sem. Fusce consequat. Nulla nisl. Nunc nisl.');
insert into company (CompanyID, Name, about)
values (16, 'Eabox', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat.');
insert into company (CompanyID, Name, about)
values (17, 'Blognation',
        'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus.');
insert into company (CompanyID, Name, about)
values (18, 'Oyoloo', 'Maecenas pulvinar lobortis est.');
insert into company (CompanyID, Name, about)
values (19, 'Skimia', 'Sed ante.');
insert into company (CompanyID, Name, about)
values (20, 'Aimbo',
...
insert into company (CompanyID, Name, about)
values (22, 'Rhynyx', 'Suspendisse potenti. In eleifend quam a odio.');
insert into company (CompanyID, Name, about)
values (23, 'Pixonyx',
...
insert into company (CompanyID, Name, about)
values (27, 'Zoozzy', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.');
insert into company (CompanyID, Name, about)
values (28, 'Twinder',
        'Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem. Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.');
insert into company (CompanyID, Name, about)
...
insert into company (CompanyID, Name, about)
values (34, 'Wordpedia', 'Integer tincidunt ante vel ipsum.');
insert into company (CompanyID, Name, about)
values (35, 'Blogpad',
...
insert into company (CompanyID, Name, about)
values (36, 'Oyonder', 'Pellentesque viverra pede ac diam.');
insert into company (CompanyID, Name, about)
values (37, 'Centizu',
...
insert into company (CompanyID, Name, about)
values (38, 'Flashpoint',
        'Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.');
insert into company (CompanyID, Name, about)
values (39, 'Oyoloo', 'Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus. Suspendisse potenti.');
insert into company (CompanyID, Name, about)
values (40, 'Shufflester',
        'Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.');
insert into company (CompanyID, Name, about)
values (41, 'Brainsphere',
        'Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.');
insert into company (CompanyID, Name, about)
values (42, 'Oyope', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.');
insert into company (CompanyID, Name, about)
values (43, 'Twimbo', 'Nulla facilisi. Cras non velit nec nisi vulputate nonummy.');
insert into company (CompanyID, Name, about)
values (44, 'Midel', 'Proin risus.');
insert into company (CompanyID, Name, about)
values (45, 'Reallinks',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (2, '49', 'Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (3, '7',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (15, '24', 'In eleifend quam a odio.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (16, '23',
...
values (23, '11',
        'Donec posuere metus vitae ipsum. Aliquam non mauris. Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis. Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (24, '29', 'Morbi non quam nec dui luctus rutrum.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (25, '40', 'Aenean sit amet justo. Morbi ut odio.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (26, '47', 'Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (27, '33',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (29, '41', 'Nunc rhoncus dui vel sem. Sed sagittis.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (30, '46',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (31, '12', 'Integer ac neque. Duis bibendum.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (32, '31', 'Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (33, '2',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (39, '39', 'Vivamus in felis eu sapien cursus vestibulum. Proin eu mi. Nulla ac enim.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (40, '19',
...
insert into benefits (BenefitID, JobID, BenefitDescription)
values (45, '35', 'Donec dapibus. Duis at velit eu est congue elementum.');
insert into benefits (BenefitID, JobID, BenefitDescription)
values (46, '1',
...
values (4, 'RTOS');
insert into skill (skillID, Name)
values (5, 'Disability Insurance');
insert into skill (skillID, Name)
values (6, 'VoIP');
insert into skill (skillID, Name)
values (7, 'PCI Standards');
insert into skill (skillID, Name)
values (8, 'Tutoring');
insert into skill (skillID, Name)
values (9, 'Embedded Systems');
insert into skill (skillID, Name)
values (10, 'HMO');
insert into skill (skillID, Name)
values (11, 'BMP design');
insert into skill (skillID, Name)
values (12, 'DP');
insert into skill (skillID, Name)
values (13, 'Construction Management');
insert into skill (skillID, Name)
values (14, 'IWR');
insert into skill (skillID, Name)
values (15, 'Olfaction');
insert into skill (skillID, Name)
values (16, 'DNA methylation');
insert into skill (skillID, Name)
values (17, 'PCR');
insert into skill (skillID, Name)
values (18, 'Aquisition');
insert into skill (skillID, Name)
values (19, 'PDMLink');
insert into skill (skillID, Name)
values (20, 'ODE');
insert into skill (skillID, Name)
values (21, 'Vendor Management');
insert into skill (skillID, Name)
values (22, 'Mortgage Underwriting');
insert into skill (skillID, Name)
values (23, 'Supply Management');
insert into skill (skillID, Name)
values (24, 'Long-term Care');
insert into skill (skillID, Name)
values (25, 'DDR2');
insert into skill (skillID, Name)
values (26, 'vBulletin');
...
values (29, 'QAS');
insert into skill (skillID, Name)
values (30, 'Mental Health Counseling');
insert into skill (skillID, Name)
values (31, 'Workplace Violence');
insert into skill (skillID, Name)
values (32, 'CMMI Level 5');
insert into skill (skillID, Name)
values (33, 'Xytech');
insert into skill (skillID, Name)
values (34, 'Natural Gas');
insert into skill (skillID, Name)
values (35, 'Civil Rights');
insert into skill (skillID, Name)
values (36, 'KNX');
insert into skill (skillID, Name)
values (37, 'TMDLs');
...
values (38, 'VSEO');
insert into skill (skillID, Name)
values (39, 'Zend Certified Engineer');
insert into skill (skillID, Name)
values (40, 'LDOM');
insert into skill (skillID, Name)
values (41, 'Organization Skills');
insert into skill (skillID, Name)
values (42, 'Urban');
insert into skill (skillID, Name)
values (43, 'Contractual Agreements');
insert into skill (skillID, Name)
values (44, 'cXML');
insert into skill (skillID, Name)
values (45, 'EWP');
...
insert into skill_test (SkillTestID, SKillID, Name)
values (1, '31', 'integer ac leo');
insert into skill_test (SkillTestID, SKillID, Name)
values (2, '28', 'non velit nec nisi');
insert into skill_test (SkillTestID, SKillID, Name)
values (3, '30', 'aliquet maecenas leo');
insert into skill_test (SkillTestID, SKillID, Name)
values (4, '13', 'id pretium iaculis diam erat');
insert into skill_test (SkillTestID, SKillID, Name)
values (5, '35', 'suspendisse potenti cras in');
insert into skill_test (SkillTestID, SKillID, Name)
values (6, '47', 'cubilia curae duis faucibus accumsan');
insert into skill_test (SkillTestID, SKillID, Name)
values (7, '24', 'ut ultrices vel');
insert into skill_test (SkillTestID, SKillID, Name)
values (8, '27', 'interdum');
insert into skill_test (SkillTestID, SKillID, Name)
values (9, '33', 'nibh in');
insert into skill_test (SkillTestID, SKillID, Name)
values (10, '9', 'lacinia nisi venenatis tristique');
insert into skill_test (SkillTestID, SKillID, Name)
values (11, '46', 'luctus et');
insert into skill_test (SkillTestID, SKillID, Name)
values (12, '40', 'sit');
insert into skill_test (SkillTestID, SKillID, Name)
values (13, '38', 'justo pellentesque viverra pede ac');
insert into skill_test (SkillTestID, SKillID, Name)
values (14, '37', 'sapien cursus vestibulum proin eu');
insert into skill_test (SkillTestID, SKillID, Name)
values (15, '14', 'scelerisque');
insert into skill_test (SkillTestID, SKillID, Name)
values (16, '3', 'ante ipsum primis in');
insert into skill_test (SkillTestID, SKillID, Name)
values (17, '17', 'congue risus semper porta volutpat');
insert into skill_test (SkillTestID, SKillID, Name)
values (18, '42', 'rutrum rutrum neque');
insert into skill_test (SkillTestID, SKillID, Name)
values (19, '19', 'eros suspendisse accumsan tortor');
insert into skill_test (SkillTestID, SKillID, Name)
values (20, '36', 'enim lorem ipsum dolor sit');
insert into skill_test (SkillTestID, SKillID, Name)
values (21, '11', 'in purus eu magna vulputate');
insert into skill_test (SkillTestID, SKillID, Name)
values (22, '12', 'lacinia');
insert into skill_test (SkillTestID, SKillID, Name)
values (23, '23', 'sagittis');
insert into skill_test (SkillTestID, SKillID, Name)
values (24, '32', 'ut');
insert into skill_test (SkillTestID, SKillID, Name)
values (25, '5', 'diam erat fermentum justo nec');
insert into skill_test (SkillTestID, SKillID, Name)
values (26, '7', 'semper interdum mauris ullamcorper purus');
insert into skill_test (SkillTestID, SKillID, Name)
values (27, '48', 'in sagittis dui');
insert into skill_test (SkillTestID, SKillID, Name)
values (28, '29', 'eget');
insert into skill_test (SkillTestID, SKillID, Name)
values (29, '4', 'convallis morbi odio odio');
insert into skill_test (SkillTestID, SKillID, Name)
values (30, '20', 'accumsan felis ut at dolor');
insert into skill_test (SkillTestID, SKillID, Name)
values (31, '39', 'in hac habitasse platea');
insert into skill_test (SkillTestID, SKillID, Name)
values (32, '18', 'sed');
insert into skill_test (SkillTestID, SKillID, Name)
values (33, '25', 'odio odio elementum eu interdum');
insert into skill_test (SkillTestID, SKillID, Name)
values (34, '21', 'dignissim');
insert into skill_test (SkillTestID, SKillID, Name)
values (35, '34', 'sit amet eleifend pede libero');
insert into skill_test (SkillTestID, SKillID, Name)
values (36, '22', 'placerat');
insert into skill_test (SkillTestID, SKillID, Name)
values (37, '15', 'lacinia');
insert into skill_test (SkillTestID, SKillID, Name)
values (38, '50', 'sit');
insert into skill_test (SkillTestID, SKillID, Name)
values (39, '44', 'nulla');
...
values (40, '2', 'sem');
insert into skill_test (SkillTestID, SKillID, Name)
values (41, '49', 'sapien varius');
insert into skill_test (SkillTestID, SKillID, Name)
values (42, '1', 'ut');
insert into skill_test (SkillTestID, SKillID, Name)
values (43, '6', 'proin');
insert into skill_test (SkillTestID, SKillID, Name)
values (44, '43', 'posuere metus');
insert into skill_test (SkillTestID, SKillID, Name)
values (45, '45', 'in tempus sit amet sem');
insert into skill_test (SkillTestID, SKillID, Name)
values (46, '10', 'primis');
insert into skill_test (SkillTestID, SKillID, Name)
values (47, '41', 'massa tempor');
insert into skill_test (SkillTestID, SKillID, Name)
values (48, '8', 'ut');
insert into skill_test (SkillTestID, SKillID, Name)
values (49, '16', 'est risus');
insert into skill_test (SkillTestID, SKillID, Name)
values (50, '26', 'sit amet');
...
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (1, '25', 'nulla nunc purus phasellus in felis donec?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (2, '21',
        'posuere metus vitae ipsum aliquam non mauris morbi non lectus aliquam sit amet diam in magna bibendum?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (3, '37',
        'ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae nulla dapibus dolor vel est donec odio justo sollicitudin ut suscipit?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (4, '27',
        'aliquam quis turpis eget elit sodales scelerisque mauris sit amet eros suspendisse accumsan tortor quis turpis sed ante vivamus tortor duis?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (5, '46', 'lobortis est phasellus?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (6, '11',
        'eget elit sodales scelerisque mauris sit amet eros suspendisse accumsan tortor quis turpis sed ante?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (7, '7', 'bibendum morbi non quam nec dui luctus rutrum nulla tellus in sagittis dui?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (8, '47',
        'in purus eu magna vulputate luctus cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus vivamus vestibulum sagittis sapien cum sociis natoque penatibus et?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (9, '24', 'sed tincidunt eu felis fusce posuere felis sed lacus morbi sem mauris?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (10, '35',
        'lorem id ligula suspendisse ornare consequat lectus in est risus auctor sed tristique in tempus sit amet sem fusce consequat nulla nisl nunc nisl duis bibendum felis sed?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (11, '13',
...
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (12, '32',
        'nibh in quis justo maecenas rhoncus aliquam lacus morbi quis tortor id nulla ultrices aliquet maecenas leo odio condimentum id luctus nec molestie sed justo pellentesque viverra pede ac?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (13, '19',
        'gravida nisi at nibh in hac habitasse platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum at lorem integer tincidunt ante vel ipsum praesent blandit?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (14, '29', 'lobortis sapien sapien non mi integer ac neque duis bibendum morbi non quam nec dui?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (15, '9',
        'diam erat fermentum justo nec condimentum neque sapien placerat ante nulla justo aliquam quis turpis eget elit sodales scelerisque mauris sit amet eros suspendisse accumsan tortor quis turpis sed ante?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (16, '44',
        'justo lacinia eget tincidunt eget tempus vel pede morbi porttitor lorem id ligula suspendisse ornare consequat lectus in?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (17, '5',
        'at feugiat non pretium quis lectus suspendisse potenti in eleifend quam a odio in hac habitasse platea dictumst maecenas ut massa?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (18, '20', 'luctus tincidunt nulla mollis molestie lorem quisque ut erat curabitur gravida nisi at nibh?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (19, '14', 'pede justo eu massa donec dapibus duis at?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (20, '38',
...
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (22, '45', 'donec posuere metus vitae ipsum aliquam non?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (23, '48',
        'nulla dapibus dolor vel est donec odio justo sollicitudin ut suscipit a feugiat et eros vestibulum ac est lacinia nisi venenatis tristique fusce congue diam id ornare?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (24, '41', 'donec vitae nisi nam ultrices libero non mattis pulvinar nulla pede ullamcorper augue a suscipit?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (25, '50', 'eu interdum eu?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (26, '28',
        'posuere cubilia curae donec pharetra magna vestibulum aliquet ultrices erat tortor sollicitudin mi?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (27, '4',
        'eu est congue elementum in hac habitasse platea dictumst morbi vestibulum velit id pretium iaculis diam erat fermentum justo nec condimentum?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (28, '31',
        'lorem integer tincidunt ante vel ipsum praesent blandit lacinia erat vestibulum sed magna at nunc commodo placerat praesent blandit nam nulla integer pede justo lacinia eget?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (29, '30',
        'vulputate elementum nullam varius nulla facilisi cras non velit nec nisi vulputate nonummy maecenas tincidunt lacus at velit vivamus?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (30, '8', 'pede justo lacinia eget tincidunt eget?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (31, '39',
        'sit amet consectetuer adipiscing elit proin risus praesent lectus vestibulum quam sapien varius ut blandit non interdum in ante vestibulum ante ipsum?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (32, '42', 'orci luctus et ultrices posuere cubilia curae mauris viverra diam vitae quam?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (33, '16',
        'vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae nulla dapibus dolor vel est donec odio justo sollicitudin ut suscipit a feugiat et eros vestibulum ac?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (34, '6',
        'tristique in tempus sit amet sem fusce consequat nulla nisl nunc nisl duis bibendum felis sed interdum?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (35, '23', 'eget vulputate ut ultrices vel augue vestibulum ante ipsum primis in?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (36, '17', 'convallis nulla neque libero convallis eget eleifend luctus ultricies eu nibh quisque?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (37, '12', 'molestie nibh in lectus pellentesque at nulla suspendisse potenti cras in?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (38, '18',
        'consequat lectus in est risus auctor sed tristique in tempus sit amet sem fusce consequat nulla nisl nunc?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (39, '10',
        'sed nisl nunc rhoncus dui vel sem sed sagittis nam congue risus semper porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci nullam molestie nibh?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (40, '3',
...
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (41, '49', 'sit amet cursus id turpis integer?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (42, '22', 'aliquam augue quam sollicitudin vitae consectetuer eget rutrum at lorem integer tincidunt?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (43, '2', 'nunc proin at turpis a pede?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (44, '15', 'luctus nec molestie sed justo pellentesque viverra pede ac diam cras?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (45, '33', 'sapien varius ut blandit?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (46, '26',
...
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (48, '34', 'molestie lorem quisque ut erat curabitur?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (49, '36', 'metus sapien ut nunc vestibulum ante ipsum primis in faucibus orci luctus?');
insert into test_questions (QuestionID, SkillTestID, QuestionText)
values (50, '1',
